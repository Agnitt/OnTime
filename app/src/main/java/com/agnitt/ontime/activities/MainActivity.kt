...
//        handler = Handler()
//        runnable = Runnable {
//            Log.d("Runnable", "Two sec are passed")
...
//            override fun onTick(millisUntilFinished: Long) {
//                Log.d("Timer", "${millisUntilFinished / 1000} seconds left")
//                min = ((millisUntilFinished / 1000) / 60).toInt()
//                sec = ((millisUntilFinished / 1000) % 60).toInt()
//                textView.text = if (min.toString().length < 2) "0$min:$sec" else "$min:$sec"
//            }
//
//            override fun onFinish() {
//                Log.d("Timer", "Finish")
